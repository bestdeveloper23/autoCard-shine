...
function GeometryParametersPanel(editor, object) {
    ...
    twistedangleRow.add(new UIText(strings.getKey('sidebar/geometry/atrapezoidp_geometry/twistedangle')).setWidth('90px'));
    ...
    function update() {
        ...
        editor.execute(new SetGeometryCommand(editor, object, new aTwistedTrapGeometry(pDx1, pDx2, pDy1, pDx3, pDx4, pDy2, pDz, pTheta, pPhi, pAlpha, twistedangle)));
    }
