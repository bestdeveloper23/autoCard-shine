function Strings(config) {
	...
	const values = {
		...
		en: {
			...
			'menubar/add/apara': 'Parallelpiped',
			'menubar/add/atrapezoid': 'Trapezoid',
			'menubar/add/atrapezoid2': 'Trapezoid11',
			'menubar/add/atrapezoid4': 'TrapeZoid4',
			'menubar/add/atorus': 'Torus',
			'menubar/add/aellipticalcylinder': 'Elliptical \nCylinder',
			'menubar/add/aellipsoid': 'Ellipsoid',
			'menubar/add/aellipticalcone': 'Elliptical \nCone',
			'menubar/add/twistedbox': 'TwistedBox',
			'menubar/add/atwistedtrd': 'TwistedTrd',
			'menubar/add/atwistedtrap': 'Twisted \nTrapezoid',
			...
			'sidebar/properties/demensionunit': 'cm',
			'sidebar/properties/angleunit': '°',
			...
			'sidebar/geometry/sphere_geometry/radiusOut': 'Outer radius',
			'sidebar/geometry/sphere_geometry/radiusIn': 'Inner radius',
			'sidebar/geometry/sphere_geometry/startPhi': 'Starting Phi angle',
			'sidebar/geometry/sphere_geometry/deltaPhi': 'Delta Phi angle',
			'sidebar/geometry/sphere_geometry/startTheta': 'Starting Theta angle',
			'sidebar/geometry/sphere_geometry/deltaTheta': 'Delta Theta angle',
			...
			'sidebar/geometry/acone_geometry/maxradius1': 'Outside radius at +pDz',
			'sidebar/geometry/acone_geometry/maxradius2': 'Outside radius at -pDz',
			'sidebar/geometry/acone_geometry/minradius1': 'Inside radius at +pDz',
			'sidebar/geometry/acone_geometry/minradius2': 'Inside radius at -pDz',

			'sidebar/geometry/aparall_geometry/dx': 'Half length in X',
			'sidebar/geometry/aparall_geometry/dy': 'Half length in Y',
			'sidebar/geometry/aparall_geometry/dz': 'Half length in Z',
			...
			'sidebar/geometry/aparall_geometry/twistedangle': 'Twist angle',

			'sidebar/geometry/atrapezoid_geometry/dx1': 'Half length in X at -dz',
			'sidebar/geometry/atrapezoid_geometry/dx2': 'Half length in X at +dz',
			'sidebar/geometry/atrapezoid_geometry/dy1': 'Half length in Y at -dz',
			'sidebar/geometry/atrapezoid_geometry/dy2': 'Half length in Y at +dz',
			'sidebar/geometry/atrapezoid_geometry/dz': 'Half length in Z',
			...
			'sidebar/geometry/atrapezoid_geometry/twistedangle': 'Twist angle',

			'sidebar/geometry/Trapezoid4/dZ': 'Length in Z',
			'sidebar/geometry/Trapezoid4/dY': 'Length in Y',
			'sidebar/geometry/Trapezoid4/dX': 'Length in X',
			'sidebar/geometry/Trapezoid4/dLTX': 'Length along X at the narrower side',
			

			'sidebar/geometry/atrapezoidp_geometry/dx1': 'Half Dx1 at -Dy, -Dz',
			'sidebar/geometry/atrapezoidp_geometry/dx2': 'Half Dx2 at +Dy, -Dz',
			'sidebar/geometry/atrapezoidp_geometry/dy1': 'Half Dy1 at -Dz',
			'sidebar/geometry/atrapezoidp_geometry/dy2': 'Half Dy2 at +Dz',
			'sidebar/geometry/atrapezoidp_geometry/dz': 'Half Dz',
			'sidebar/geometry/atrapezoidp_geometry/dx3': 'Half Dx3 at +Dz , -Dy',
			'sidebar/geometry/atrapezoidp_geometry/dx4': 'Half Dx4 at +Dz , +DY ',
			'sidebar/geometry/atrapezoidp_geometry/alpha': 'alpha',
			'sidebar/geometry/atrapezoidp_geometry/alpha1': 'alpha1',
			'sidebar/geometry/atrapezoidp_geometry/alpha2': 'alpha2',
			'sidebar/geometry/atrapezoidp_geometry/theta': 'theta',
			...
			'sidebar/geometry/aparaboloid_geometry/height': 'Half length Z',

			'sidebar/geometry/ahyperboloid_geometry/radiusout': 'Outer radius',
			'sidebar/geometry/ahyperboloid_geometry/radiusin': 'Inner radius',
			'sidebar/geometry/ahyperboloid_geometry/stereoout': 'Outer stereo angle',
			'sidebar/geometry/ahyperboloid_geometry/stereoin': 'Inner stereo angle',
			'sidebar/geometry/ahyperboloid_geometry/height': 'Half length Z',

			'sidebar/geometry/apolycone_geometry/radius': 'Radius',
			'sidebar/geometry/apolycone_geometry/z': 'z',
			'sidebar/geometry/apolycone_geometry/znumber': 'Number of Z planes',
			'sidebar/geometry/apolycone_geometry/sphi': 'Initial Phi starting angle',
			'sidebar/geometry/apolycone_geometry/dphi': 'Total Phi angle',

			'sidebar/geometry/apolyhedra_geometry/radius': 'Radius',
			'sidebar/geometry/apolyhedra_geometry/z': 'z',
			'sidebar/geometry/apolyhedra_geometry/numside': 'Number of sides',
			...
			'sidebar/material/nistMaterials': 'NIST Compounds',
			'sidebar/material/HNMaterials': 'HEP and Nuclear',
			'sidebar/material/spaceMaterials': 'Space(ISS)',
			'sidebar/material/bioChemicalMaterials': 'Bio-Chemical',
			...
			'sidebar/modify/replicas/count': 'Number of copies',
			'sidebar/modify/replicas/radius': 'Radius',
			'sidebar/modify/replicas/angle': 'Angle',
			'sidebar/modify/replicas/distance': 'Distance between copies',
