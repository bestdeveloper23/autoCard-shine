function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/geometry/atrapezoidp_geometry/dx1': 'Half length X at smaller Y, -dz',
			'sidebar/geometry/atrapezoidp_geometry/dx2': 'Half length X at smaller Y, +dz',
			...
			'sidebar/geometry/atrapezoidp_geometry/dx3': 'Half length X at smaller Y, +pDz',
			'sidebar/geometry/atrapezoidp_geometry/dx4': 'Half length X at bigger Y, +pDz',
			...
			'sidebar/geometry/aellipsoid_geometry/ztopcut' : 'lower Z',
			'sidebar/geometry/aellipsoid_geometry/zbottomcut' : 'upper Z',
