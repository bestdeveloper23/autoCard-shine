function Strings(config) {
	...
	const values = {
		...
		en: {
			...
			'menubar/add/atwistedtrap': 'TwistedTrap',
			...
			'sidebar/geometry/atrapezoidp_geometry/dx1': 'Half length X at -Y, -dz',
			'sidebar/geometry/atrapezoidp_geometry/dx2': 'Half length X at -Y, +dz',
			'sidebar/geometry/atrapezoidp_geometry/dy1': 'Half length Y at -dz',
			'sidebar/geometry/atrapezoidp_geometry/dy2': 'Half length Y at +dz',
			'sidebar/geometry/atrapezoidp_geometry/dz': 'Half length in Z',
			'sidebar/geometry/atrapezoidp_geometry/dx3': 'Half length X at +Y, -Dz',
			'sidebar/geometry/atrapezoidp_geometry/dx4': 'Half length X at +Y, +Dz',
